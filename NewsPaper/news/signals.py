...
def notify_new_post(sender, instance: PostCategory, **kwargs):
    """
    Реакция на добавление связки вследствие нового поста
    """
    post = instance.post
...
def new_user(sender, instance: User, **kwargs):
    """
    Реакция на нового пользователя
    """
